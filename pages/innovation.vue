        ...
        <div class="d-flex align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="container">
                <div :class="{ 'dark-active': isDark, 'dark-inactive': !isDark }" class="sticky-top">
                    ...
                    <div class="row mt-3">
                        <div class="col-3"></div>
                        <div class="col-6 text-center dark:text-white">
                        ...
                        <!-- <div class="col-1 align-self-center">
                            <select class="form-select" aria-label="Select time range">
                                ...
                                <option value="2">Last 8 hours</option>
                                <option value="3">Last 1 hour</option>
                            </select>
                        </div>
...
const queryRealtimeChange = (name, table, values) => useAsyncData(
    name,
    async () => {
        let timeRange = 5;
        let timeUnit = 'minute';
...
const updateLatestAndChart = async (data, latest, chartData, chartId, loaded, param, label) => {
    if (data) {
        ...
        const colorState = isDark.value ? 'dark' : 'light';
